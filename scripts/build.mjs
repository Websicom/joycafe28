...
assert(Array.isArray(booking.partySizes) && booking.fallbackUrl?.startsWith('https://'), 'booking.json is invalid.');
...
await writeFile(path.join(root, 'site.webmanifest'), JSON.stringify({ name: site.name, short_name: 'Joy Cafe', description: 'Healthy by day, naughty by night.', start_url: '/', display: 'standalone', background_color: '#f8f4ec', theme_color: '#f8f4ec', icons: [{ src: '/assets/brand/joy-favicon-512.png', sizes: '512x512', type: 'image/png' }] }, null, 2));
