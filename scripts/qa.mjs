...
assert(homepage.includes('--page-bg:#fbfaf6') && homepage.includes('--sage:#acb095') && homepage.includes('--page-bg:#2e2926') && homepage.includes('--text:#fffaf6'), 'index.html: requested light palette and strong white-text dark palette should be inlined');
