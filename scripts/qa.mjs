...
assert(homepage.includes('Nourishing food · simple plates · coffee · cheese · wine · good vibes.<span class="hero-intro-second">Pop in for a drink, a light bite or request a table below.</span>'), 'index.html: hero introduction should use the current client copy with a spaced second line');
...
assert(!homepage.includes('Your table at Joy') && homepage.includes('If you’d like to book a table at joy, please fill in the form below.'), 'index.html: booking introduction should use the requested lowercase joy copy without its old eyebrow');
...
assert(homepage.includes('<h2 id="story-title">Welcome to joy</h2>') && homepage.includes('Created with Joy, to bring you joy.'), 'index.html: story copy should use the requested Joy capitalisation');
