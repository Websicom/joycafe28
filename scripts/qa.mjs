...
assert(homepage.includes('Nourishing food · simple plates · coffee · cheese · wine · good vibes.<br>Pop in for a drink, a light bite or request a table below.'), 'index.html: hero introduction should use the current client copy on two lines');
